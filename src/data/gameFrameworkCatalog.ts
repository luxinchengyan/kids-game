...
export const frameworkCatalog: FrameworkCatalogSection[] = [
  ...
  },
  {
    ...
    title: '智趣棋牌中心',
    icon: '♟️',
    description: '通过经典的棋牌游戏，训练策略规划、逻辑推理和全局视野。',
    color: '#795548',
    games: [
      {
        id: 'gomoku',
        name: '五子棋',
        description: '经典的五子连珠游戏，适合训练空间观察和博弈意识。',
        goal: '策略规划',
        tags: ['对弈', '空间'],
        status: 'playable',
        playPath: '/games/board/gomoku',
      },
      {
        id: 'minesweeper',
        name: '扫雷大冒险',
        description: '通过逻辑推理排除地雷，锻炼分析能力。',
        goal: '逻辑推理',
        tags: ['逻辑', '数字'],
        status: 'playable',
        playPath: '/games/board/minesweeper',
      },
      {
        id: 'chinese-chess',
        name: '中国象棋',
        description: '体验博大精深的中国棋文化，楚河汉界智勇对决。',
        goal: '博弈策略',
        tags: ['文化', '策略'],
        status: 'playable',
        playPath: '/games/board/xiangqi',
      },
      {
        id: 'chess',
        name: '国际象棋',
        description: '智慧的交锋，经典的博弈，锻炼全局视野。',
        goal: '策略规划',
        tags: ['竞技', '逻辑'],
        status: 'playable',
        playPath: '/games/board/chess',
      },
      {
        id: 'go-game',
        name: '围棋入门',
        description: '围而胜之，在黑白交替中领略逻辑之美。',
        goal: '计算能力',
        tags: ['逻辑', '计算'],
        status: 'playable',
        playPath: '/games/board/go',
      },
      {
        id: 'military-chess',
        name: '军棋大战',
        ...
        tags: ['策略', '判断'],
        status: 'playable',
        playPath: '/games/board/military-chess',
      },
      {
        id: 'halma',
        name: '跳棋',
        description: '经典的益智跳棋，通过跳跃先到达终点。',
        goal: '逻辑思维',
        tags: ['益智', '策略'],
        status: 'playable',
        playPath: '/games/board/halma',
      },
      {
        id: 'card-games',
        name: '趣味牌类',
