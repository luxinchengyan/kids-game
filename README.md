...
童梦神舟是一款专为学龄前儿童设计的互动学习应用,通过游戏化学习帮助孩子掌握:

- **汉语拼音** - 声母、韵母、整体认读音节
- **数学启蒙** - 数字认知、简单运算、逻辑思维
- **英语启蒙** - 基础词汇、日常用语
- **传统文化** - 神话故事、古诗词、成语故事
- **综合百科** - 地理、历史、化学、物理、生物等跨学科小知识
- **AI 打字训练** - 用 AI 主题小游戏熟悉键盘布局、提升打字兴趣与基础输入能力

### 核心特性

- ✅ **个性化学习** - 基于艾宾浩斯遗忘曲线的智能复习系统
- ✅ **游戏化激励** - 星星奖励、成就系统、连续打卡
- ✅ **学习路径** - 世界地图主线、阶段成长路线与每周学习日历
- ✅ **百科拓展** - 参考综合常识知识框架构建儿童百科知识站
- ✅ **家长监控** - 学习报告、进度追踪、数据导出
- ✅ **离线支持** - 核心功能无需网络
